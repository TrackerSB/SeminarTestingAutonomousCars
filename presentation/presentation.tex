...
\videoframeHref{2019-02-21_BasicUnoptimizedScenario.mp4}{no URL}

%\videoframe{media/drivableArea_slow.mp4}
\videoframeHref{drivableArea_slow.mp4}{no URL}
%\videoframe{media/drivableArea_fast.mp4}
\videoframeHref{drivableArea_fast.mp4}{no URL}

\fsFrame{Limit 50 km/h}
%\videoframe{media/beamNG_toSlow.mp4}
\videoframeHref{beamNG_toSlow.mp4}{no URL}
\fsFrame{Limit 70 km/h}
%\videoframe{media/beamNG_adequate.mp4}
\videoframeHref{beamNG_adequate.mp4}{no URL}
\fsFrame{Limit 80 km/h}
%\videoframe{media/beamNG_toFast.mp4}
\videoframeHref{beamNG_toFast.mp4}{no URL}
\fsFrame{Limit 70 km/h}
%\videoframe{media/beamNG_adequate_freeView.mp4}
\videoframeHref{beamNG_adequate_freeView.mp4}{no URL}
%\videoframe{media/drivableArea_development.mp4}
\videoframeHref{drivableArea_development.mp4}{no URL}
