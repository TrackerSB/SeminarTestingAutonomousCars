...
\videoframeHref{no URL}{2019-02-21\_BasicUnoptimizedScenario.mp4}

%\videoframe{media/drivableArea_slow.mp4}
\videoframeHref{no URL}{drivableArea\_slow.mp4}
%\videoframe{media/drivableArea_fast.mp4}
\videoframeHref{no URL}{drivableArea\_fast.mp4}

\fsFrame{Limit 50 km/h}
%\videoframe{media/beamNG_toSlow.mp4}
\videoframeHref{no URL}{beamNG\_toSlow.mp4}
\fsFrame{Limit 70 km/h}
%\videoframe{media/beamNG_adequate.mp4}
\videoframeHref{no URL}{beamNG\_adequate.mp4}
\fsFrame{Limit 80 km/h}
%\videoframe{media/beamNG_toFast.mp4}
\videoframeHref{no URL}{beamNG\_toFast.mp4}
\fsFrame{Limit 70 km/h}
%\videoframe{media/beamNG_adequate_freeView.mp4}
\videoframeHref{no URL}{beamNG\_adequate\_freeView.mp4}
%\videoframe{media/drivableArea_development.mp4}
\videoframeHref{no URL}{drivableArea\_development.mp4}
