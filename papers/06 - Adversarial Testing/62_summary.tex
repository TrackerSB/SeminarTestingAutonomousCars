...
\begin{enumerate}
    \item DeepRoad is able to generate synthetic images with weather conditions like heavy rain or heavy snow.
        How could the intensity of the rain or snow be controlled to further increase the diversity of input images?
    \item The paper describes that other approaches get confused if input images are disturbed (\eg{} by little black squares) but the paper only deals with consistency concerning changes in the weather conditions.
        Is DeepRoad able to check inconsistencies arising from disturbances of input images?
\end{enumerate}
