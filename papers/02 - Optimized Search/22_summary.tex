...
\begin{tabularx}{\textwidth}{lXX}
    ...
    \midrule
    \cite{vehicleSurrogate} & \makecell{ResearchGate\\(Citations tab)} & This paper uses a similar approach in sense of the introduced surrogate model.\\
    \midrule
    \cite{efficientOptimization} & \makecell{IEEExplore search\\(Search string:\\``stochastic optimization'')}& \draft{Also uses particle swarm; further optimizations on the stochastic part}\\
    \midrule
