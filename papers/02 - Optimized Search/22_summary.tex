...
\begin{tabularx}{\textwidth}{lXX}
    ...
    \midrule
    \cite{kriging} & \makecell{IEEExplore\\(Reference to all papers of the\\same conference)} & This paper introduces a similar statistical approach which is also based on Kriging models.\\
    \midrule
