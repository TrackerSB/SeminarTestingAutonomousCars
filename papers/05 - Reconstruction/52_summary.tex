...
It explains every step taken in the simulations, every parameter considered at any step, problems occurring at certain points in the simulation like the visibility of other participants and also how they solved them (\eg{} detection lines).
\draft{In the case of detection lines they even mentioned the criteria visibility.}\par
...
\draft{%
    \begin{enumerate}
        \item Quantitative measurement of benefits? More physical variables to consider?
    \end{enumerate}
}
